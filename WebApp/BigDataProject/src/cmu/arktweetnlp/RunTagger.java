...
/*		int i=0;
	...
	public void outputPrependedTagging(Sentence lSent, ModelSentence mSent, 
		...
		System.out.println("see:"+sb.toString());
		System.out.println("wow1:"+StringUtils.join(tokens));
		System.out.println("wow2:"+StringUtils.join(tags));
		System.out.println("wow3:"+StringUtils.join(confs));
		String text1 = StringUtils.join(tokens);
	    try {
	      File file = new File("/Users/qianyizhong/Desktop/example1.txt");
		...
		String text2 = StringUtils.join(tags);
	    try {
	      File file = new File("/Users/qianyizhong/Desktop/example2.txt");
	      BufferedWriter output = new BufferedWriter(new FileWriter(file));
	      output.write(text2);
	      output.close();
	    } catch ( IOException e ) {
